...
from api.views import course_list, course_detail, CourseListAPIView, CourseDetailAPIView, CategoryListAPIView, CategoryDetailAPIView, wishlist, list_wishlist,clear_wishlist,clear_cart, cart, list_cart, current_course,teacher_courses, list_current_courses, buy_current_courses
...
urlpatterns = [
    ...
    path('wishlist/<int:student_id>/clear',clear_wishlist),

    path('courses/<int:course_id>/cart/<int:student_id>', cart),
    path('cart/<int:student_id>', list_cart),
    path('cart/<int:student_id>/clear',clear_cart),
    ...
    path('categories/courses/<int:teacher_id>/',teacher_courses),
